...
def create_client():
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({"msg": "Erreur lors de la création du client", "error": str(e)}), 500
...
def get_clients():
    try:
        ...
        return jsonify({"msg": "Erreur lors de la récupération des clients", "error": str(e)}), 500
...
def get_client(client_id):
    try:
        ...
        return jsonify({"msg": "Erreur lors de la récupération du client", "error": str(e)}), 500
...
def update_client(client_id):
    try:
        ...
        db.session.rollback()
        return jsonify({"msg": "Erreur lors de la mise à jour du client", "error": str(e)}), 500
...
def delete_client(client_id):
    try:
        ...
        db.session.rollback()
        return jsonify({"msg": "Erreur lors de la suppression du client", "error": str(e)}), 500
...
def convert_prospect(client_id):
    try:
        ...
        db.session.rollback()
        return jsonify({"msg": "Erreur lors de la conversion du prospect", "error": str(e)}), 500
...
def blacklist_client(client_id):
    try:
        ...
        db.session.rollback()
        return jsonify({"msg": "Erreur lors de la mise en blacklist", "error": str(e)}), 500
