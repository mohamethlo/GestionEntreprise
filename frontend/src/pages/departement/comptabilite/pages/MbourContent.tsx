...
import { Plus, FileText, Trash2, Edit, CheckCircle2, XCircle, Eye } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold">Gestion des Dépenses - Mbour</h2>
          <p className="text-sm text-muted-foreground">
            Gérez les dépenses et les approvisionnements pour la région de Mbour
          </p>
        </div>
