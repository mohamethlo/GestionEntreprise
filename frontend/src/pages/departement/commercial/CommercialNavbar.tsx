...
import { Home, FileCheck, FileText, Users, Settings, Package, PackagePlus, ShieldAlert, FileSearch, Sparkles, Zap } from "lucide-react";
...
export const NAV_ITEMS = [
  ...
  { key: "devis", label: "Devis", icon: FileCheck },
...
const CommercialNavbar = ({ activeTab, setActiveTab }) => {
  return (
    <div className="p-4">
          ...
          return (
            <Button
              ...
              className={`
                ...
                ${isActive 
                  ? // Style actif - Bouton avec animations premium
                    'bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-2xl hover:shadow-3xl rounded-xl ' +
                    'hover:scale-105 hover:from-green-700 hover:to-emerald-700 ' +
                  ...
                  : // Style inactif - Bouton blanc avec animations
                    ...
                    'active:scale-95 ' +
                    'shadow-gray-200/50 hover:shadow-green-500/20 ' +
                    'hover:border-green-400/50 hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50'
                }
            ...
            >
              ...
              <div className={`
                ...
                ${isActive ? 'via-white/40' : 'via-green-100/60'}
              `} />
              ...
              <IconComponent className={`
                ...
                ${isActive 
                  ...
                  : 'text-gray-600 group-hover:text-green-600 group-hover:scale-110 group-hover:rotate-12'
                }
              ...
              {/* Élément Sparkles pour les boutons spéciaux */}
              {(item.key === "devis" || item.key === "proformas") && isActive && (
                <Sparkles className="absolute -top-1 -left-1 h-3 w-3 text-yellow-300 animate-spin" />
              )}
            </Button>
          );
        })}
      ...
      <style>{`
        ...
        * {
        ...
        /* Animation spéciale pour les éléments commerciaux importants */
        ...
        .commercial-glow {
          animation: commercial-glow 2s ease-in-out infinite;
        }
      `}</style>
    </div>
  );
