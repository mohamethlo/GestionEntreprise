...
const InterventionHeader = ({ navigate }) => {
    ...
    <div className="sticky top-0 z-10 border-b border-primary/20 bg-surface/100 backdrop-blur-sm">
      <div className="p-4 flex items-center justify-between">
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-xl font-extrabold text-primary">Département Intervention</h1>
        </div>
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 top-12 mt-1 w-48 bg-white rounded-lg shadow-xl border border-gray-200 py-1 z-20 animate-in fade-in-80">
              ...
              <div className="px-4 py-3 border-b border-gray-100">
                <p className="text-sm font-semibold text-gray-900">Administrateur Intervention</p>
                <p className="text-xs text-gray-500 mt-1">intervention@netsysteme.com</p>
              </div>
