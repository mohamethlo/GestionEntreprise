...
import { Home,Wrench,Users,Settings,Calendar } from "lucide-react";
...
export const NAV_ITEMS = [
  ...
  { key: "installation", label: "Installation", icon: Settings },
  { key: "equipe", label: "Equipe technique", icon: Users },
];

const InterventionNavbar = ({ activeTab, setActiveTab }) => {
  return (
    <div className="p-4">
...
export default InterventionNavbar;